      ...
      <div className='p-8 rounded-lg w-full md:w-1/2  lg:w-1/3 flex flex-col gap-y-4 ' >
        ...
        <form className='flex flex-col gap-y-5 p-5 rounded-md outline' onSubmit={handleSubmit(onRegister)}>
          ...
          <div className='flex flex-col gap-y-2'>
            ...
            <input type="email" id='email' className='rounded-md outline-1 px-2 py-2.5 text-md' placeholder='adiniz@mail.com' {...register('email', {
              required: { value: true, message: 'Alan boş bırakılamaz.' },
          ...
          <div className='flex flex-col gap-y-2'>
            ...
            <input type="password" id='password' className='rounded-md outline-1 px-2 py-2.5 text-md' placeholder='En az 8 haneli şifreniz'  {...register('password', {
              required: { value: true, message: 'Alan boş bırakılamaz.' },
